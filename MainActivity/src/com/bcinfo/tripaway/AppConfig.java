...
import com.bcinfo.tripaway.view.CircleBitmapDisplayer;
...
public class AppConfig {
	...
	public static DisplayImageOptions options(int defaultIMG) {
	...
	// 获取圆角图片
	public static DisplayImageOptions roundoptions(int defaultIMG, int round) {
		DisplayImageOptions defaultOptions = new DisplayImageOptions.Builder() //
				.showImageForEmptyUri(defaultIMG).displayer(new RoundedBitmapDisplayer(20)) // default
																							// 还可以设置圆角图片
				//
				.showImageOnFail(defaultIMG)
				//
	...
	public static DisplayImageOptions getCircleOption() {
		return new DisplayImageOptions.Builder().showImageOnLoading(R.drawable.user_defult_photo)
				.showImageForEmptyUri(R.drawable.user_defult_photo).showImageOnFail(R.drawable.user_defult_photo)
