...
public class ProductNewInfo implements Parcelable
{
    ...
    public static final Parcelable.Creator<ProductNewInfo> CREATOR = new Parcelable.Creator<ProductNewInfo>()
    {
        public ProductNewInfo createFromParcel(Parcel source)
        {
            return new ProductNewInfo(source);
        }
        
        public ProductNewInfo[] newArray(int size)
        {
            return new ProductNewInfo[size];
        }
    };
    
    public ProductNewInfo(Parcel in)
    {
