...
public class MessageInfo implements Parcelable, Comparable<MessageInfo>
{
    ...
    public MessageInfo(Parcel in)
    {
        ...
        productInfo = in.readParcelable(ProductNewInfo.class.getClassLoader());
    ...
    public void writeToParcel(Parcel out, int flags)
    {
        ...
        out.writeParcelable(productInfo, 0);
        out.writeParcelable(sender, 0);
    }
