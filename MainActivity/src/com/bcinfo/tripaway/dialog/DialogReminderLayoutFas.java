...
public class DialogReminderLayoutFas extends AlertDialog implements android.view.View.OnClickListener
{

    private Context mContext;
    private AccountFasInterface accountUnbindInterface;
    ...
    public DialogReminderLayoutFas(Context context, AccountFasInterface accountUnbindInterface)
    {
        super(context);
    ...
    protected void onCreate(Bundle savedInstanceState)
    {
        ...
        setContentView(R.layout.dialog_reminder_layout_fas_cash);
    ...
    public interface AccountFasInterface
    {
