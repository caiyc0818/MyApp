...
public class FindPassWordResultDialog extends Dialog
{
     ...
     * 
     */
    public FindPassWordResultDialog(Context context, int theme)
    {
        super(context, theme);
     ...
     * @return 自定义对话框实例
     */
    public static   FindPassWordResultDialog createDialog(final Context context, int layoutId)
    {

        final FindPassWordResultDialog customDialog1 = new FindPassWordResultDialog(context,
