package com.bcinfo.tripaway.editText;
...
/**
 * 
 * 创建一个继承EditText的自定义文本框输入控件 用于实现附带删除图标 具有删除功能的editText
 * @function
 * @author caihelin
 * @version 1.0 2014年12月8日 14:45:44
 * 
 * 
 */
public class DeletedEditText extends EditText implements OnFocusChangeListener, TextWatcher
{
...
//       mdrawable.setBounds(DensityUtil.px2dip(this.getContext(), -5), DensityUtil.px2dip(this.getContext(), 0), DensityUtil.px2dip(this.getContext(), 150), DensityUtil.px2dip(this.getContext(), 150));
        // 下面的方法可以避免在不同尺寸的手机上图片失真
       mdrawable.setBounds(DensityUtil.dip2px(this.getContext(), -15), DensityUtil.dip2px(this.getContext(), 0), DensityUtil.dip2px(this.getContext(), 10), DensityUtil.dip2px(this.getContext(), 25));
        // 初始状态是不可见的
