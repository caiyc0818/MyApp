...
public class AlbumHelper
{
    ...
    {
        String[] projection =
            {Albums._ID, Albums.ALBUM, Albums.ALBUM_ART, Albums.ALBUM_KEY, Albums.ARTIST, Albums.NUMBER_OF_SONGS};
    ...
    void buildImagesBucketList()
    {
        ...
        // 构造相册索引
        String columns[] =
            new String[] {Media._ID, Media.BUCKET_ID, Media.PICASA_ID, Media.DATA, Media.DISPLAY_NAME, Media.TITLE,
        ...
        while (itr.hasNext())
        {
            ...
            Log.d(TAG, entry.getKey() + ", " + bucket.getBucketName() + ", " + bucket.getCount() + " ---------- ");
            for (int i = 0; i < bucket.getImageList().size(); ++i)
            {
                ImageItem image = bucket.getImageList().get(i);
                Log.d(TAG,
                    "----- " + image.getImageId() + ", " + image.getImagePath() + ", " + image.getThumbnailPath());
            }
        }
