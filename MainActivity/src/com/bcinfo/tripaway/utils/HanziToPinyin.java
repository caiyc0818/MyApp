...
//		   }
    ...
    private static   List<String> zh_chList=new ArrayList<String>(8);
    
    static{
    	zh_chList.add("zh");
    	zh_chList.add("zh_HANS");
    	zh_chList.add("zh_HANS_CN");
    	zh_chList.add("zh_HANS_SG");
    	zh_chList.add("zh_HANT_HK");
    	zh_chList.add("zh_HANT_MO");
    	zh_chList.add("zh_HANT_TW");
    	zh_chList.add("zh_HANT");
    }
    ...
    public static HanziToPinyin getInstance() {  
        synchronized (HanziToPinyin.class) {  
            ...
            for (int i = 0; i < locale.length; i++) {  
                if (locale[i].equals(Locale.CHINA)||zh_chList.contains(locale[i].toString())) {  
