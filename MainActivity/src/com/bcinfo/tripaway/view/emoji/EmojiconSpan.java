...
public void setUri(String uri) {
    ...
    public EmojiconSpan(Context context, Drawable drawable, int size, int textSize,String uri)
    {
        super(DynamicDrawableSpan.ALIGN_BASELINE);
        mContext = context;
        mDrawable = drawable;
    ...
    public Drawable getDrawable()
    {
        if (mDrawable == null)
        {
            try
            {
                ...
                mWidth =  mSize;
                mHeight =mWidth * mDrawable.getIntrinsicHeight() / mDrawable.getIntrinsicWidth();
                mTop = (mTextSize - mWidth) / 2;
