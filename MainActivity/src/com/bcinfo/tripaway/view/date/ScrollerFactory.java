...
public class ScrollerFactory
{
    ...
    private final static String DRUM_SCROLLER = "com.bcinfo.tripaway.view.date.DrumPickerScroller";
    private final static String OVER_SCROLLER = "android.widget.OverScroller";
    private final static String DRUM_SCROLLER2 = "com.bcinfo.tripaway.view.date.DrumPickerScroller2";
