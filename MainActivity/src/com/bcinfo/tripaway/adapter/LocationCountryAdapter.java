 ...
 */
public class LocationCountryAdapter extends BaseAdapter {
	private Context mcontext;

	private List<ProductNewInfo> productList;

	public LocationCountryAdapter(Context mContext, List<ProductNewInfo> productList) {
	...
	public View getView(int position, View convertView, ViewGroup container) {
		...
		if (convertView == null) {
			...
			LogUtil.e("new object", "position", ""+position);
			convertView = inflator.inflate(R.layout.location_country_detail_item, null); // time
																							// 几天
																							// 千米
			...
			LogUtil.e("cache", "position", ""+position);
		...
		holder.productIntroduceTv.setText(productNewInfo.getDescription());
		}
		return convertView;
	}
