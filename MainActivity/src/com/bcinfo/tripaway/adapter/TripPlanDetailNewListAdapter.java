...
public class TripPlanDetailNewListAdapter extends BaseAdapter
{
    ...
    public TripPlanDetailNewListAdapter(Context context, List<ProductServiceResource> list, Journey mJourney)
    {
    ...
    public View getView(final int position, View convertView, ViewGroup parent)
    {
        ...
        if (convertView == null)
        {
            convertView = inflater.inflate(R.layout.trip_plan_detail_new_listitem, null);
        ...
        holder.scenicIndex.setText(resource.getRank());
        holder.scenicName.setText(resource.getServName());
        holder.scenicName1.setText(jouser.getTitle());// //biaoti
        holder.textabstract.setText(resource.getServDesc());// miaosu
