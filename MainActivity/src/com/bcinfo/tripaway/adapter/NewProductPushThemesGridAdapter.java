 ...
 */
public class NewProductPushThemesGridAdapter extends BaseAdapter {
	...
	public NewProductPushThemesGridAdapter(Context context,
...
//		if (position == 5&&themeList.size()>6) {
//			ViewHolder holder;
//			if (convertView == null) {
//				holder = new ViewHolder();
//				convertView = inflator.inflate(
//						R.layout.new_item_discovery_theme_list, null);
...
//			}
//
//			holder.themeIconIv.setImageResource(R.drawable.winter);
...
//		}
		...
		if (convertView == null) {
			holder = new ViewHolder();
			convertView = inflator.inflate(R.layout.new_item_discovery_theme_list,
					null);
//			holder.subjectIcon = (ImageView) convertView
//					.findViewById(R.id.subject_icon);
			holder.themeIconIv = (ImageView) convertView
