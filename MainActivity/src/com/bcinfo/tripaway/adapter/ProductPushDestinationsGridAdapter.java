...
public class ProductPushDestinationsGridAdapter extends BaseAdapter
{
    ...
    public ProductPushDestinationsGridAdapter(Context context, List<PushResource> locationList)
    {
    ...
    public View getView(int position, View convertView, ViewGroup parent)
    {
      ...
      Log.e("ProductPushDestinationsGridAdapter", Integer.toString(position));
       ...
       /* ImageLoader.getInstance().displayImage(locationItem.getTitleImage(),
        ...
        if (locationItem.getObjectType().equals("destination")) {
        	holder.locationzhNameTv.setTextSize(TypedValue.COMPLEX_UNIT_SP, 18);
