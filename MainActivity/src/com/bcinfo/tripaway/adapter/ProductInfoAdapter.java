...
public class ProductInfoAdapter extends BaseAdapter
{
    ...
    public ProductInfoAdapter(Context mContext, List<ProductNewInfo> productList)
    {
    ...
    public View getView(int position, View convertView, ViewGroup container)
    {
        ...
        if (convertView == null)
        {
            ...
            convertView = inflator.inflate(R.layout.item_product_layout, null); // time 几天 千米
            ...
            // holder.productDaySchedualTv = (TextView)convertView.findViewById(R.id.product_servicer_timeSchedual_tv);
            // holder.productDistanceTv = (TextView)convertView.findViewById(R.id.product_servicer_distance_tv);
            holder.productIntroduceTv = (TextView)convertView.findViewById(R.id.product_servicer_introduce_tv);
            holder.bookNumTv= (TextView)convertView.findViewById(R.id.bookNum);
			...
			holder.pickedTag3 = (TextView) convertView.findViewById(R.id.trip_picked_tag3_lable);            holder.productIntroduceTv .setEllipsize(TruncateAt.END);
			holder.pickedTag4 = (TextView) convertView.findViewById(R.id.trip_picked_tag4_lable);            holder.productIntroduceTv .setEllipsize(TruncateAt.END);
		...
		if (!StringUtils.isEmpty(productNewInfo.getOriginalPrice())&&"0".equals(productNewInfo.getOriginalPrice())==false&&
				(price<price2)) {
        ...
        // holder.productDistanceTv.setText(productNewInfo.getDistance() + "km");
        ...
        holder.bookNumTv.setText(productNewInfo.getTotal());
        return convertView;
    }
