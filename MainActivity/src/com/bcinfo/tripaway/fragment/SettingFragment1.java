...
import com.bcinfo.tripaway.activity.ConsultOrComplaintActivity;
import com.bcinfo.tripaway.activity.HelpActivity;
...
public class SettingFragment1 extends BaseFragment
{
    ...
    {
        View settingView = inflater.inflate(R.layout.setting1, container, false);
        ...
        if (((SettingActivity)getActivity()).isNewVersion)
        {
        ...
        complaintLayout=(RelativeLayout)settingView.findViewById(R.id.complaint);// 帮助
        ...
        complaintLayout.setOnClickListener(setFragmentClickListener);
        ...
        public void onClick(View v)
        {
            ...
            // break;
                ...
                case R.id.setting_AboutUs:// 关于我们
                    startActivity(new Intent(SettingFragment1.this.getActivity(), SettingAboutUsActivity.class));
                    animationOpen();
                    break;
                case R.id.setting_CheckForUpdate:// 版本检查
                    startActivity(new Intent(SettingFragment1.this.getActivity(), SettingUpdateVersionActivity.class));
                    animationOpen();
                    break;
                case R.id.setting_Help:// 帮助
                    startActivity(new Intent(SettingFragment1.this.getActivity(), HelpActivity.class));
                    animationOpen();
                    break;
                case R.id.complaint://投诉
                	Intent intent1 = new Intent(SettingFragment1.this.getActivity(), ConsultOrComplaintActivity.class);
                ...
                case R.id.exitLayout:// 退出账号
                    exitDialog =
                        ApplyExitDialog.createDialog(SettingFragment1.this.getActivity(), R.layout.setting_exit_dialog);
                ...
                case R.id.setting_cache_confirm_layout:// 清除缓存-确定
                    Toast.makeText(SettingFragment1.this.getActivity(), "确定", 0).show();
                    setDialog.dismiss();
                    break;
                case R.id.setting_cache_cancel_layout:// 清除缓存-取消
                    Toast.makeText(SettingFragment1.this.getActivity(), "取消", 0).show();
                    setDialog.dismiss();
                    break;
                ...
                case R.id.setting_exitDialog_confirm_layout:// 退出-确定
                    ...
                    Intent intent2=new Intent("com.bcinfo.PickedFragment");
                	getActivity().sendBroadcast(intent2);
                	  Intent intent31 = new Intent("com.bcinfo.squre");
                      getActivity().sendBroadcast(intent31);
                	exitLayout.setVisibility(View.GONE);
                    exitDialog.dismiss();
                    exitLayout.setVisibility(View.GONE);
//                    goLoginActivity();
