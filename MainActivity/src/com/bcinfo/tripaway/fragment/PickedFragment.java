 ...
 * 
 */
public class PickedFragment extends BaseFragment implements IXListViewListener {
	/**
	...
	public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
		...
		pickedAdapter = new PickListAdapter(pickedItemList, this.getActivity(), new OperationListener() {
		  ...
		  loginLoading = (View)tripPickedView.findViewById(R.id.login_loading);
		...
		HttpUtil.get(Urls.picked_url, new JsonHttpResponseHandler() {
			...
			public void onSuccess(int statusCode, Header[] headers, JSONObject response) {
				...
				if (statusCode == 200) {
					...
					((View)loginLoading.getParent()).setBackgroundColor(Color.BLACK);
