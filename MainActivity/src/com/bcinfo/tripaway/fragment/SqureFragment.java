 ...
 * 
 */
public class SqureFragment extends BaseLazyFragment implements IXListViewListener, OnClickListener {
	...
	public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
		...
		squareListView = (XListView) view.findViewById(R.id.all_square_listview);
		...
		loginLoading = (View) view.findViewById(R.id.login_loading);
		...
		HttpUtil.get(Urls.get_bymcode, params, new JsonHttpResponseHandler() {
			...
			public void onSuccess(int statusCode, Header[] headers, JSONObject response) {
				...
				if ("00000".equals(code)) {
					...
					if (ThemeList.size() > 0) {
						if (squareListView.getHeaderViewsCount() == 1) {
						...
						if (headview1 != null && squareListView.getHeaderViewsCount() == 2) {
