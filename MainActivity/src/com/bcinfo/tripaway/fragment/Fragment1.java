...
import com.bcinfo.tripaway.view.textview.BoldTfTextView;
...
public class Fragment1 extends BaseFragment {
	...
	public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
		...
		tabLin = (LinearLayout) view.findViewById(R.id.tab);
		// 设置标题
		((View) button_more_columns.getParent()).setOnClickListener(new OnClickListener() {
			...
			public void onClick(View v) {
				if (tag % 2 == 0) {
					pw.showAsDropDown(button_more_columns);
	...
	private void initView(View view) {
		...
		pw = new PopupWindow(contentView, mScreenWidth, (mScreenHigh - DensityUtil.dip2px(getActivity(), 104)));
	...
	private void initFragment() {
		...
		mAdapetr = new SquareFragmentPagerAdapter(getChildFragmentManager(), fragments);
		// 去除过度动画
