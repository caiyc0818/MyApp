 ...
 * @function
 * @author     JiangCS  
 * @version   1.0, 2014年12月16日 上午11:17:00
 */
public class AlarmProvider extends ContentProvider
{
    ...
    static
    {
        sURLMatcher.addURI("com.bcinfo.tripaway", "alarm", ALARMS);
        sURLMatcher.addURI("com.bcinfo.tripaway", "alarm/#", ALARMS_ID);
    }
    private static class DatabaseHelper extends SQLiteOpenHelper
    {
        ...
        {
            db.execSQL("CREATE TABLE alarms (" + "_id INTEGER PRIMARY KEY," + "year INTEGER, "+ "month INTEGER, "+ "dayofmonth INTEGER, "+ "hour INTEGER, " + "minutes INTEGER, "
                     + "alarmtime INTEGER, " + "enabled INTEGER, " + "vibrate INTEGER, "
        ...
        {
            LogUtil.i(TAG, "onUpgrade", "Upgrading alarms database from version " + oldVersion + " to " + currentVersion);
    ...
    public int update(Uri url, ContentValues values, String where, String[] whereArgs)
    {
        ...
        LogUtil.i(TAG, "update"," rowId= " + rowId + " /url= " + url);
