...
public class MessageActivity1 extends BaseActivity implements OnClickListener, OnItemClickListener, IXListViewListener
{
    protected static final String TAG = "MessageActivity1";
...
//	private String type;
	...
	protected void onCreate(Bundle arg0) 
    {
        ...
        View header = LayoutInflater.from(this).inflate(R.layout.message_fragment_header, null);
        ...
        second_title.setBackgroundColor(getResources().getColor(R.color.title_bg));
    ...
    private void initListView()
    {
        ...
        mMessageListAdapter = new QueuesListAdapter(this, queuesInfoList);
...
//                ToastUtil.showToast(this, "error=" + throwable.getMessage());
            }
...
//                ToastUtil.showToast(this, "error=" + throwable.getMessage());
            ...
            public void onSuccess(int statusCode, Header[] headers, JSONObject response)
            {
                ...
                LogUtil.i(TAG, "查询消息列表接口2", response.toString());
...
//                                }
                ...
                {
//                    ToastUtil.showToast(this, "errorCode=" + response.optString("code"));
                    if (isPullRefresh)
                    {
                        // 下拉刷新接口返回的数据不正确
                        mMessageListView.stopRefresh();
    ...
    public void onClick(View v)
    {
        ...
        switch (v.getId())
        {
            ...
            case R.id.notice_layout:
                  ...
                  animationOpen();
            	break;
            case R.id.single_chat_layout:
            	 intent = new Intent(this,MessageActivity.class);
          	   intent.putExtra("type","private");
                startActivity(intent);
                animationOpen();
            	break;
            case R.id.group_chat_layout:
            	 intent = new Intent(this,MessageActivity.class);
